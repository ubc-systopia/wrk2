...
./wrk -t$threads -c$connections -d${time}s -R10000 -H 'accept-encoding: gzip, deflate, br' -s \
...
-R10000 https://139.19.171.104/mediawiki/index.php?title=Mecsplicateur
...
./wrk -t$threads -c$connections -d${time}s -H 'accept-encoding: gzip, deflate, br' \
-R10000 https://139.19.171.104/mediawiki/index.php?tiitle=Water
...
./wrk -t$threads -c$connections -d${time}s -H 'accept-encoding: gzip, deflate, br' \
-R10000 https://139.19.171.104:4444/mediawiki/index.php?title=Mecsplicateur
...
./wrk -t$threads -c$connections -d${time}s -H 'accept-encoding: gzip, deflate, br' \
-R10000 https://139.19.171.104:4444/mediawiki/index.php?tiitle=Water
